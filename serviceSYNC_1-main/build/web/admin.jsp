...
Class.forName("com.mysql.jdbc.Driver");
 ...
 PreparedStatement st=con.prepareStatement("select * from admin_table where adminId=? and adminPassword=?");
    ...
    Cookie ck=new Cookie("serviceSYNC","adminId");
    ck.setMaxAge(100000);
   response.addCookie(ck); 

         session.setAttribute("boom", adminId);
               response.sendRedirect("adminDeshbord.jsp");
            }
    ...
    <body>
        ...
        <div class="contain">
            <div class="text">
                ...
                <table> <th> Admin Login</th>
                    <tr><td> <input class="inp1" type="text" name="aId" placeholder="enter adminId" required=""></td></tr>
                    <tr><td><input class="inp2" type="password" name="pwd" placeholder="enter adminPassword" required=""></td></tr>
