 ...
 %>       
    ...
    <marquee>AUTOMOBILE SERVICE AT YOUR DOOR STEPS </marquee>
        ...
        <div class='divtheme'>
            ...
            <a href="userPasswordUpdate.jsp"><button class="button">Update Password</button></a>
                <a href="userEditProfile.jsp"><button class="button1">Edit Profile</button></a>
          
            </table>
              <a href="userDeleteAccount.jsp"><button class="button1">Delete Account</button></a>
