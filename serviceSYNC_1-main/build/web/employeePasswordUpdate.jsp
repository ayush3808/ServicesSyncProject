...
PreparedStatement st1=
                con.prepareStatement("update  employee_table set empPassword=? where empId=?");       
    ...
    <marquee>AUTOMOBILE SERVICE AT YOUR DOOR STEPS </marquee>
        ...
        <div class="contain">
            <div class="text">
              ...
              <tr><td>  <input class="inp1" type="text"  name="empId" placeholder="enter empId" required=""></td></tr>
