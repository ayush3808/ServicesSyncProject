...
Class.forName("com.mysql.jdbc.Driver");
 ...
 PreparedStatement st=con.prepareStatement("select * from employee_table where empId=? and empPassword=?");
    ...
    Cookie ck=new Cookie("serviceSYNC","empId");
    ck.setMaxAge(100000);
   response.addCookie(ck); 


            
         session.setAttribute("SHUBH",empId );
               response.sendRedirect("employeeDeshbord.jsp");
            }
    ...
    <body>
        ...
        <div class="contain">
            <div class="text">
                ...
                <table> <th> Employee Login</th>
                    <tr><td> <input class="inp1" type="text" name="eId" placeholder="enter EmployeeId" required=""></td></tr>
