...
Class.forName("com.mysql.jdbc.Driver");
 ...
 PreparedStatement st=con.prepareStatement("select * from employee_table where empId=? and empPassword=?");
        ...
        if(rs.next())
        {
               ...
               response.sendRedirect("enterServiceNo.jsp");
            }
...
<%@page  import="java.sql.ResultSet"%>
<%   
    String idValue=(String)session.getAttribute("SHUBH");
       Class.forName("com.mysql.jdbc.Driver");
      Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/serviceSYNC","root","root");
      PreparedStatement st=con.prepareStatement("select * from employee_table where empId=? ");
    ...
    <body>
        ...
        <div class="contain">
            <div class="text">
                ...
                <table> <th> Accept Service</th>
                    <tr><td> <input class="inp1" type="text" name="eId" value="<%=empId%>" required="" readonly="" ></td></tr>
                    <tr><td><input class="inp2" type="password" name="pwd" placeholder="enter password" required=""></td></tr>
                    <tr><td><p>Forgot Password</p></td></tr>
                
                 <tr><td><input type="submit" class="button" Value="Next" name="btn1"></td></tr>
                 <tr><td><p>Not a member?&nbsp;<a href="employeeDeshbord.jsp">Not interested</a> </p></td></tr>
