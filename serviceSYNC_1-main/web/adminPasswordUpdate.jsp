...
<%
 ...
 Class.forName("com.mysql.jdbc.Driver");
        ...
        if(newPassword.equals(conPassword))
            {    
             PreparedStatement st1=con.prepareStatement("update  admin_table set adminPassword=? where adminId=? ");
            ...
            {
                out.println("newPassword and confirmPassword is miss matched");
            }
        }
        else
        {
            out.println("invalide id password");
    ...
    <marquee>AUTOMOBILE SERVICE AT YOUR DOOR STEPS </marquee>
        ...
        <div class="contain">
            <div class="text">
              ...
              <tr><td>  <input class="inp1" type="text"  name="AdminId" placeholder="enter AdminId" required=""></td></tr>
